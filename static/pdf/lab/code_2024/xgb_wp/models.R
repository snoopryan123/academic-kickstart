...
load_params <- function(model_name) {
  params = list.load(paste0("", model_name, ".yaml"))
  nrounds = params$nrounds
  catalytic = params$CATALYTIC
  params = within(params, rm(model_name))
  params = within(params, rm(CATALYTIC))
  params = within(params, rm(test_loss))
...
xgb_wp_110_6_model_name = "xgb_wp_110_6"
xgb_wp_110_6_features = c(
  "score_differential", "game_seconds_remaining", "posteam_spread", "yardline_100", "scoreTimeRatio",
  "receive_2h_ko", "posteam_timeouts_remaining", "defteam_timeouts_remaining"
)
xgb_wp_110_6_monotonicities = c(1,0,-1,-1,1,  0,1,-1)
# determined by our parameter tuning
# xgb_wp_110_6_params <-  list(booster = "gbtree",
...
#                              min_child_weight = 4,
#                              monotone_constraints = xgb_wp_110_6_monotonicities
# )
# xgb_wp_110_6_nrounds = 100
# xgb_wp_110_6_catalytic = FALSE
xgb_wp_110_6_params = load_params(xgb_wp_110_6_model_name)[[1]]
xgb_wp_110_6_nrounds = load_params(xgb_wp_110_6_model_name)[[2]]
xgb_wp_110_6_catalytic = load_params(xgb_wp_110_6_model_name)[[3]]

##############################
xgb_wp_110_6_catalytic_model_name = "xgb_wp_110_6_catalytic" ###
xgb_wp_110_6_catalytic_prior_name = "gam_wp_110_s_2" ###
xgb_wp_110_6_catalytic_paramFile = paste0(xgb_wp_110_6_catalytic_model_name, "_prior_", xgb_wp_110_6_catalytic_prior_name) ###
xgb_wp_110_6_catalytic_features = get(paste0(str_remove(xgb_wp_110_6_catalytic_model_name, "_catalytic"), "_features"))
# determined by testing on a validation set
xgb_wp_110_6_catalytic_params = load_params(xgb_wp_110_6_catalytic_paramFile)[[1]]
xgb_wp_110_6_catalytic_nrounds = load_params(xgb_wp_110_6_catalytic_paramFile)[[2]]
xgb_wp_110_6_catalytic_catalytic = load_params(xgb_wp_110_6_catalytic_paramFile)[[3]]
