...
# out.width = "85%"
nick <- c(0,0,-21.36,-32.75,-7.16,0.68,-9.32,-59.32)
ryan <- c(0,0,-2.27,11.37,57.91,103.37,77.44,27.44)
guest_profits <- c(NA,NA,NA,NA,NA,13.63,NA,-50)
guest_names <- c(NA,NA,NA,NA,NA,"Frank",NA,"Kole")
