...
# out.width = "85%"
nick <- c(0,26.97,-23.03,20.53)
ryan <- c(0,-7.83,17.82,37.92)
Elon <- c(0, -7.79, -27.29,-14.79)
Shelon <- c(0, -23.2, -50.4,-37.9)
Belon <- c(0,-50,-100,-87.5)
guest_profits <- c(NA,23.76, 17.40,43.59,-21.36)
guest_names <- c(NA,"Harry", "Griff", "Kole","Jake")
guest_weeks <- c(0,1,1,2,3)
