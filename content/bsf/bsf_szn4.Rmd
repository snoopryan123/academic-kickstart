...
# out.width = "85%"
nick <- c(0,0,-34.08,-27.52,-67.57,-117.57,-167.57,-179.39,-129.38,-126.19,-157.10,-207.10,-228.46,-278.46,-241.21,-243.48)
ryan <- c(0,0,39.31,55.54,41.43,30.94,10.85,25.75,36.13,48.77,22.63,-9.46,-21.28,-32.55,-50.75,-81.66)
guest_profits <- c(NA,NA,4.69,NA,-21.36,6.68,-50,-21.49,-11.82,-50,NA,NA,NA,NA,NA,-50,-2.27)
guest_names <- c(NA,NA,"Harry",NA,"Griff","Frank","Kole","Brandon","Jake","Aaron",NA,NA,NA,NA,NA,"Adil","Harry")
guest_weeks <- c(0,1,2,3,4,5,6,7,8,8,9,10,11,12,13,14,15)
