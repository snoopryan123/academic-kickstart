...
# out.width = "85%"
nick <- c(0,0,-34.08,-27.52,-67.57,-117.57,-167.57)
ryan <- c(0,0,39.31,55.54,41.43,30.94,10.85)
guest_profits <- c(NA,NA,4.69,NA,-21.36,6.68,-50)
guest_names <- c(NA,NA,"Harry",NA,"Griff","Frank","Kole")
guest_weeks <- c(0,1,2,3,4,5,6)
