...
* Regularization & ridge regression
    ...
    * [lab](/pdf/lab/labs_2024/Regularization_and_Ridge_Regression.pdf), data: NBA lineup data from Ramiro Bentes' Github `https://github.com/ramirobentes/nba_pbp_data/raw/main/possessions2024/data.rds`, in a `.rds` file format which you may need to convert to `.csv` in `R` to analyze in other programming languages
